"""
Django settings for sistema_valledor project.
...
SECRET_KEY = '7l91pl(%jyo3&zc!pukoqt!o&@6$4ce(fxij5iv9^8eechl9uw'
...
ROOT_URLCONF = 'sistema_valledor.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vendedor.processor.Traer_Categorias',
            ],
        },
    },
]

WSGI_APPLICATION = 'sistema_valledor.wsgi.application'
