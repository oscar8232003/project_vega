...
class Listas(models.Model):
    ...
    nombre = models.CharField(verbose_name="Nombre de la lista", null=True, blank=True, max_length=50)
    ...
    estado_lista = models.CharField(verbose_name="Estado de la lista", max_length=20, null=True, blank=True, choices=estados_de_listas, default='normal')
...
class Reporte_listas(models.Model):
    ...
    local = models.ForeignKey(Local, on_delete= models.CASCADE, null = True, blank = True)
    nombre_lista = models.CharField(verbose_name="Nombre de la lista", max_length=50, null=True, blank=True)
    ...
    estado = models.CharField(verbose_name="Estado del pedido", null=True, blank=True, max_length=20)
...
class Reporte_productos(models.Model):
    ...
    nombre_producto = models.CharField(verbose_name="Nombre Producto", max_length=50, null=True, blank=True)
