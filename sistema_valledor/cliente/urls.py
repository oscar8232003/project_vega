...
from .views import Panel_Cliente, Listar_Productos, Detalle_Productos, Listado_Locales, Detalle_Locales, \
    ...
    Eliminar_Productos_Listas, Actualizar_Productos_Listas
...
cliente_urlpatterns = ([
    ...
    path('detalle_listas/<int:id>/eliminar_producto_lista/<int:id_prod>',Eliminar_Productos_Listas, name="eliminar_producto_lista"),
    path('detalle_listas/<int:id>/actualizar_producto_lista/<int:id_prod>',Actualizar_Productos_Listas, name="actualizar_producto_lista"),
    ],'cliente')